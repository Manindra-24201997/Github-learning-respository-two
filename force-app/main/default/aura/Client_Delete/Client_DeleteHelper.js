({
	delete_Client : function(component, event, helper) {
        var recId = component.get("v.recordId");
        var SobjName ="JobSuite__Client__c";
        var delActon=component.get("c.DeleteClient");
            delActon.setParams({"ClientId": recId});
