({
    ...
    onloadrecord : function(component, event, helper) {
        ...
        if(recId!=null){
            ...
            setTimeout($A.getCallback(function() {
                component.find("RoleId").set("v.value", VenConFields.record.fields.JobSuite__Role__c.value);
            }),1500);
        }
    },
    ...
    RecordSubmit: function(component, event, helper) {
        ...
        VenConFields["JobSuite__Vendor__c"]=component.get("v.simpleRecord.JobSuite__Vendor__c");
        var FirstName;
        var LastName;
        var missField = "";
        var missField1 = "";
        ...
        var reduceReutrn = component.find('VenConField').reduce(function(validFields, inputCmp) {   
            if(inputCmp.get("v.fieldName") == "JobSuite__First_Name__c" ){
                ...
                if (LastName == null || LastName == '') 
                    ...
                    else if(inputCmp.get("v.fieldName") == "JobSuite__User_Name__c"){
                ...
                event.preventDefault();
                    ...
                    event.preventDefault();
                        ...
                        event.preventDefault();   
                            ...
                            VenConFields["JobSuite__Role__c"]=component.find("RoleId").get("v.value");
