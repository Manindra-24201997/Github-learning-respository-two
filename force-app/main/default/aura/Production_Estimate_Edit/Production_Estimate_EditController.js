({
    ...
    closeModel: function(component, event, helper) {
     ...
     jobProEstload:  function(component, event, helper) { 
        ...
        if(recId!=null){
            ...
            component.find("GLDSelectId").set("v.value",ProEstfilds.record.fields.JobSuite__GL_Department__c.value);
            
            var GLCodeVal=ProEstfilds.record.fields.JobSuite__GL_Code__c.value;
            var MIVal=ProEstfilds.record.fields.JobSuite__Material_Item__c.value;
            var VendorVal=ProEstfilds.record.fields.JobSuite__Vendor__c.value;
           ...
           /* var CalUnit=ProEstfilds.record.fields.JobSuite__Calc_Unit__c.value;
            console.log("========CalUnit===="+CalUnit);
            console.log("========CalUnit true===="+(CalUnit!=''));
            if(CalUnit!=''){
                if(CalUnit=='Size'){
          ...
          /*  setTimeout($A.getCallback(function() {
                component.find("GLCodeSelectId").set("v.value",ProEstfilds.record.fields.JobSuite__GL_Code__c.value);
            ...
            setTimeout($A.getCallback(function() {
                component.find("MISelectId").set("v.value",ProEstfilds.record.fields.JobSuite__Material_Item__c.value);
                component.find("VendorId").set("v.value",ProEstfilds.record.fields.JobSuite__Vendor__c.value);
    ...
    jobProEstOnsubmit : function(component, event, helper) {
        ...
        console.log('========'+component.get("v.simpleRecord").JobSuite__Job__c);
        ProEstfields["JobSuite__Job__c"]=component.get("v.simpleRecord").JobSuite__Job__c;
        var missField = "";
        var missField1 = "";
        var missField2 = "";
                    ...
                    event.preventDefault();   
                        ...
                        event.preventDefault();   
                            ...
                            event.preventDefault();   
                                ...
                                if(ProEstfields.JobSuite__Qty_Up__c==null && ProEstfields.JobSuite__of_Pages__c==null){
                                    ProEstfields["JobSuite__Qty_Up__c"]=1;
                                }
                                if(ProEstfields.JobSuite__Quantity__c==null){
                                    ProEstfields["JobSuite__Quantity__c"]=1;
                                }
                                if(ProEstfields.JobSuite__Calc_Unit__c=='Sheet' && ProEstfields.JobSuite__Sided__c=='Double' && ProEstfields.JobSuite__Qty_Up__c !=null && ProEstfields.JobSuite__Divide_Sheets_By_Two__c==true){
                                    ProEstfields["JobSuite__SheetQtyUpforUsed__c"]=(ProEstfields.JobSuite__Quantity__c/ProEstfields.JobSuite__Qty_Up__c)/2;
                                }
                                else if (ProEstfields.JobSuite__Calc_Unit__c=='Sheet' && ProEstfields.JobSuite__Sided__c=='Double' && ProEstfields.JobSuite__Qty_Up__c !=null && ProEstfields.JobSuite__Divide_Sheets_By_Two__c==false){
                                   ProEstfields["JobSuite__SheetQtyUpforUsed__c"]=(ProEstfields.JobSuite__Quantity__c/ProEstfields.JobSuite__Qty_Up__c);
                                }
                                else if(ProEstfields.JobSuite__Calc_Unit__c=='Sheet' && ProEstfields.JobSuite__Sided__c=='Single' && ProEstfields.JobSuite__Qty_Up__c !=null){
                                   ProEstfields["JobSuite__SheetQtyUpforUsed__c"]=(ProEstfields.JobSuite__Quantity__c/ProEstfields.JobSuite__Qty_Up__c);
                                 }
                                else if(ProEstfields.JobSuite__Calc_Unit__c=='Each' && ProEstfields.JobSuite__Qty_Up__c !=null){
                                    ProEstfields["JobSuite__EachQtyUpforUsed__c"]=(ProEstfields.JobSuite__Quantity__c/ProEstfields.JobSuite__Qty_Up__c);
                                 } 
                                
                                ProEstfields["JobSuite__Material_Item__c"]=component.find("MISelectId").get("v.value");
                                ProEstfields["JobSuite__GL_Department__c"]=component.find("GLDSelectId").get("v.value");
                                ProEstfields["JobSuite__GL_Code__c"]=component.find("GLCodeSelectId").get("v.value");
                                ProEstfields["JobSuite__Vendor__c"]=component.find("VendorId").get("v.value");
