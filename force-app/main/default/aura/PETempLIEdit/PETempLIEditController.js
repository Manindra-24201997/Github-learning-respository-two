({
    ...
    RecordSubmit: function(component, event, helper) {
       ...
       // console.log('========'+component.get("v.recordId"));
        //  ProEstfields["JobSuite__Production_Estimate_Template__c"]=component.get("v.recordId");
        var missField = "";
        var missField1 = "";
        var missField2 = "";
                ...
                event.preventDefault();   
                    ...
                    event.preventDefault();   
                        ...
                        event.preventDefault();   
                            ...
                            ProEstfields["JobSuite__Calc_Unit__c"]=component.get("v.simpleRecord").JobSuite__Calc_Unit__c;
