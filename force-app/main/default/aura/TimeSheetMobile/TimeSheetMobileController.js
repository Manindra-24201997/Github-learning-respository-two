        ...
        else if(TaskName==null || TaskName=='')
        {
            ...
            else if(TSDate==null || TSDate=='')
            {
                ...
                else
                {
                    ...
                    TSfields["JobSuite__Job__c"]=component.find("JobNameId").get("v.value");
                    TSfields["JobSuite__Task_Name__c"]=component.find("TaskNameId").get("v.value");
                    TSfields["JobSuite__GL_Code__c"]=component.get("v.GLCodeofTaskid");
                    var STET=component.get('v.isStartEnd');
                    if(STET)
                    {
                        TSfields["JobSuite__Hours_Worked__c"]=component.get("v.TotalHoursWorked");
                    }
                    if(component.get("v.selectedLookUpRecord_User").Id==null){
                        TSfields["JobSuite__User__c"]="";
                    } 
                    else{
                        TSfields["JobSuite__User__c"]=component.get("v.selectedLookUpRecord_User").Id;
                    }
    ...
    jobTSload:  function(component, event, helper) { 
        ...
        if(recId==null){
           ...
           // component.find("auraUserId").set("v.value",userID);
            if(TSfilds.record.fields.JobSuite__User__c.value==null){
