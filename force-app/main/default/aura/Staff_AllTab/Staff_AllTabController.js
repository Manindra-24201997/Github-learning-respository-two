({
                        ...
                        else if(Profile==null || Profile=='' || Profile=='--None--')
                        {
                            ...
                            else if(Role==null || Role=='' || Role=='--None--')
                            {
                                ...
                                else
                                {
                                    ...
                                    Stafffields["JobSuite__Profile__c"]=component.find("StaffProfileId").get("v.value");
                                    console.log('===Profile==='+component.find("StaffProfileId").get("v.value"));
                                    Stafffields["JobSuite__Role__c"]=component.find("staffRoleId").get("v.value");
                                    console.log('===Role==='+component.find("staffRoleId").get("v.value"));
                                    Stafffields["JobSuite__Alias__c"]=alias;
    ...
    { 
        ...
        var pageReference = {
            ...
            attributes: {
                componentName: 'JobSuite__Admin_Staff',
            }         
        };
    ...
    Staffload:  function(component, event, helper) { 
        ...
        if(recId!=null){
            ...
            setTimeout($A.getCallback(function() {
                component.find("StaffProfileId").set("v.value",Stafffields.record.fields.JobSuite__Profile__c.value);
            }), 500);
            setTimeout($A.getCallback(function() {
                component.find("staffRoleId").set("v.value",Stafffields.record.fields.JobSuite__Role__c.value);
            }), 500);
