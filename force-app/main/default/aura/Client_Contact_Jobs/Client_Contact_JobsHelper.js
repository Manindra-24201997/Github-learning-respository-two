        ...
        Objaction.setCallback( helper, function( response ) {
            ...
            if(component.isValid() && response.getState() === 'SUCCESS' ) {
                ...
                component.set('v.columns', [
                    {label: tableHeader.JobSuite__Job__c.JobSuite__Job_Auto_Number__c.label, fieldName: 'JobSuite__Job_Auto_Number__c', sortable: true, type: 'integer'},
                    {label: tableHeader.JobSuite__Job__c.Name.label, fieldName: 'JobLink', sortable: true, type: 'url', typeAttributes: { label: { fieldName: 'Name' }, target: '_self', tooltip :{ fieldName: 'Name' }} },
                    {label: tableHeader.JobSuite__Job__c.JobSuite__Start_Date__c.label, fieldName: 'JobSuite__Start_Date__c',sortable: true,sortable: true, type: 'date-local' , cellAttributes: { iconName: 'utility:event', iconAlternativeText: 'Start Date'}},
                    {label: tableHeader.JobSuite__Job__c.JobSuite__Completion_Date__c.label, fieldName: 'JobSuite__Completion_Date__c', sortable: true, type: 'date-local' , cellAttributes: { iconName: 'utility:event', iconAlternativeText: 'Completion Date'}},
                    {label: tableHeader.JobSuite__Job__c.JobSuite__Due_Date__c.label, fieldName: 'JobSuite__Due_Date__c', sortable: true, type: 'date-local' , cellAttributes: { iconName: 'utility:event', iconAlternativeText: 'Due Date'}},
                    {label: tableHeader.JobSuite__Job__c.JobSuite__Status__c.label, fieldName: 'JobSuite__Status__c',sortable: true, type: 'text'},
                ]);  
            } else {
