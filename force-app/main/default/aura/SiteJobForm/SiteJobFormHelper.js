({
    ...
    FetchFieldsfromFS :  function(component, event, helper){
        ...
        action.setParams({
            sObjName : "JobSuite__Job__c",
            fieldsetname : "JobSuite__JobRequestFormFields"
        });
    ...
    getSpecObjLabels: function(component, event, helper) {
        ...
        SpecObjaction.setParams({
            sObjName : 'JobSuite__Job_Spec__c'
        }); 
    ...
    recordSubmitHelp: function(component, event, helper) {
           var recId=component.get("v.recordId");
                ...
                var reduceReutrn=component.find('fsOne').reduce(function (validFields, inputCmp) {
                    ...
                    if(inputCmp.get("v.fieldName") == "JobSuite__Due_Date__c" ){
                            ...
                            else if(SpecTemp==null || SpecTemp=='')
                            {
                                ...
                                else
                                {
                                    ...
                                    if(typeof(component.get("v.selectedLookUpRecord_MT").Id)==="undefined"){
                                        fields["JobSuite__Media_Type__c"]="";
                                    }
                                    else{
                                        fields["JobSuite__Media_Type__c"]=component.get("v.selectedLookUpRecord_MT").Id;
                                    }
                                    
                                    if(typeof(component.get("v.selectedLookUpRecord_ST").Id)==="undefined"){
                                        fields["JobSuite__Schedule_Template__c"]="";
                                    }
                                    else{
                                    ...
                                    fields["JobSuite__JS_Client__c"]=component.get("v.selectedLookUpRecord_C").Id;
                                    fields["JobSuite__JS_Client_Contact__c"]=component.get("v.selectedLookUpRecord_CC").Id;
                                    fields["JobSuite__Specification_Template__c"]=SpecTemp;
