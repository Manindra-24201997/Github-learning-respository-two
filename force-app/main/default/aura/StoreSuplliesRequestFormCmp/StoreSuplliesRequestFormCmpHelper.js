({
        ...
        getShowItems.setCallback(this, function(Response){
            ...
            if(Response.getState()=='SUCCESS'){
                ...
                if(materialItemListagain.length <= 0 ){
                    ...
                    toastEvent.fire();
                    component.set("v.showhomepagesearchbox",true);
                ...
                if(materialItemList && materialItemList.length > 0){
                    // added on 27 - 12 - 2022 by manindra for serach
                    ...
                    component.set('v.showmicategory',false);
                    component.set('v.showhomepagesearchvalueitems',false); // added on 27 - 12 - 2022 by manindra for serach
    ...
    submitToPlaceOrder : function(component, event, helper,cartItems){
        ...
        var val = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent);
                ...
                if(Response.getReturnValue() == 'DM'){
                    ...
                    window.setTimeout(
                        ...
                        toastEvent.setParams({
                            ...
                            "type":"error",
                            "duration":'3000',
                            "message": "Your order has been not placed succesfully."
                        });
                        toastEvent.fire();  
                    }
                        else{
