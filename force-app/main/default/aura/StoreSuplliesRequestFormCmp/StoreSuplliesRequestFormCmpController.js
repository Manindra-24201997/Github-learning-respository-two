({
    ...
    onMiSelectHomePageSearch : function(component, event, helper) {     
        ...
        if(mTypeSelected){
            ...
            component.get("v.homepagesearchvaluefrom",'');// logic added by manindra on 27 - 12 - 2022
            component.set("v.carthold",true); // logic added by manindra on 27 - 12 - 2022
            component.set("v.showhomepagesearchvalueitems",false);
            component.set("v.MaterialItems",null);
            //alert('else mTypeSelected');
        }   
    },
    ...
    onMiSelect : function(component, event, helper) {
        ...
        component.set('v.homepagesearchvaluefrom','');// added on 27 - 12 - 2022 by manindra for serach
        component.set("v.showhomepagesearchbox",false);// added on 27 - 12 - 2022 by manindra for serach
    ...
    DisplayItemCategory : function(component, event, helper) {
        ...
        component.set("v.showhomepagesearchbox",true); //code added by manindra on 27-12-2022
    },
    ...
    continueShopping : function(component, event, helper){        
        ...
        component.set("v.showmicategory",false);
        component.set("v.showhomepagesearchbox",true);  // This line changed on 27 - 12 - 2022
        component.set("v.showhomepagesearchvalueitems",false);  // This line changed on 27 - 12 - 2022
        component.set("v.isStoreSupplies",true);// This line changed on 27 - 12 - 2022
