({
    ...
    placeOrder : function(component, event, helper,combinedWrapper,selectedMaterialItems){
        var submitOrder=component.get("c.placeOrder");
        submitOrder.setParams({
            "CombinedWrapperList":combinedWrapper,
            "MIWrapperList":selectedMaterialItems
        });
        submitOrder.setCallback(this,function(Response){ 
            console.log('-----Response---'+Response.getState());
            console.log('-----Response---'+JSON.stringify(Response.getReturnValue()));
            ...
            if(Response.getReturnValue()=='success'){
                ...
                component.set("v.isSpinner", false);
                    ...
                    toastEvent.setParams({
                        ...
                        "type":"error",
                        "message": "Email and BillingInstructions are required field."
                    });
                    toastEvent.fire();
                    component.set("v.isSpinner", false);
                }
