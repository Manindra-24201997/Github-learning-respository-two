({
    ...
    onloadrecord : function(component, event, helper) {
        ...
        if (recId != null) {
            ...
            if(simRec.JobSuite__Job__c!=null ){
                var JobObj={"Id":simRec.JobSuite__Job__c, "Name":simRec.JobSuite__Job__r.Name};
    ...
    RecordSubmit: function(component, event, helper) {
       ...
       // Shpfields["JobSuite__Job__c"] = component.get("v.JobauraId");
        var NameField = "";
        ...
        var reduceReturn=component.find('JobShpField').reduce(function(validFields, inputCmp){
            if(inputCmp.get("v.fieldName") == "JobSuite__Shipment_Name__c")
            {
        ...
        else if(JobField==="undefined" || JobField==null)
        {
            ...
            Shpfields["JobSuite__Job__c"]=component.get("v.selectedLookUpRecord_Job").Id;  
