({
    fetchFieldLabels :function (component, event, helper){
      var action=component.get("c.getObjectFieldLabels");
        action.setParams({
            ObjNames:['JobSuite__Timesheet_Entries__c']
        });
        ...
        action.setCallback(this, function(res){
            if(res.getState() === "SUCCESS"){
                ...
                component.set("v.columns",[
                    { label:tableHeaders.JobSuite__Timesheet_Entries__c.Name.label, fieldName: 'TSId', sortable: true, type: 'url', typeAttributes: { label: { fieldName: 'Name' }, target: '_self', tooltip:{ fieldName: 'Name' }}},
                    { label:tableHeaders.JobSuite__Timesheet_Entries__c.JobSuite__Job__c.label, fieldName: 'JobName', sortable: true, type: 'text'},
                    { label:tableHeaders.JobSuite__Timesheet_Entries__c.JobSuite__Task_Name__c.label, fieldName: 'JobSuite__Task_Name__c', type: 'text', sortable: true},
                    { label:tableHeaders.JobSuite__Timesheet_Entries__c.JobSuite__Date__c.label,fieldName: 'JobSuite__Date__c', type: 'date-local', sortable: true, cellAttributes: { iconName: 'utility:event', iconAlternativeText:tableHeaders.JobSuite__Timesheet_Entries__c.JobSuite__Date__c.label}},
                    { label:tableHeaders.JobSuite__Timesheet_Entries__c.JobSuite__Hours_Worked__c.label, fieldName: 'JobSuite__Hours_Worked__c', sortable: true, type: 'number', cellAttributes: {alignment:'left'}}
                ]);
            }
            else{
