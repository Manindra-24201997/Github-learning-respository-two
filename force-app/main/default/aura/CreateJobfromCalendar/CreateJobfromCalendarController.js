({
    ...
    onloadrecord : function(component, event, helper){
        try
        {
            ...
            var ShowNotrequiredJob =PECustomSetting.JobSuite__Remove_Required_of_Job_name__c;
            var ShowNotReScheduleJob=PECustomSetting.JobSuite__Recalculate_Schedule_Job__c;
            console.log('===record Load fieldsets==='+fieldsets);
            console.log('===record Load==='+(recId==null));
            console.log('===ClientContactInfo=='+CConInfo);
            console.log('===update schdule=='+fieldsets.includes('JobSuite__UpdateSchedDateFieldCheck__c'));
            ...
            if(recId==null){
                if(CConInfo!=null){
                    var CObj={"Id":CConInfo.JobSuite__Client__c, "Name":CConInfo.JobSuite__Client__r.Name};
                ...
                if(fieldsets.includes('JobSuite__UpdateSchedDateFieldCheck__c')){
                ...
                component.find("StartTime").set("v.value",Jobfields.record.fields.JobSuite__Start_Time__c.value);
                component.find("EndTime").set("v.value",Jobfields.record.fields.JobSuite__End_Time__c.value);
            }
    ...
    RecordSubmit : function(component, event, helper) {
        ...
        var ShowNotrequiredJob =PECustomSetting.JobSuite__Remove_Required_of_Job_name__c;
        var ShowNotReScheduleJob=PECustomSetting.JobSuite__Recalculate_Schedule_Job__c;
        var ShowPE=PECustomSetting.JobSuite__Active__c;
                        ...
                        event.preventDefault();   
                            ...
                            event.preventDefault();   
                                ...
                                if(typeof(component.get("v.selectedLookUpRecord_CMP").Id)==="undefined"){
                                    fields["JobSuite__Campaign__c"]="";
                                }
                                else{
                                    fields["JobSuite__Campaign__c"]=component.get("v.selectedLookUpRecord_CMP").Id;  
                                }
                                
                                if(typeof(component.get("v.selectedLookUpRecord_CT").Id)==="undefined"){
                                    fields["JobSuite__Specification_Template__c"]="";
                                } 
                                else{
                                    fields["JobSuite__Specification_Template__c"]=component.get("v.selectedLookUpRecord_CT").Id;
                                }
                                
                                if(typeof(component.get("v.selectedLookUpRecord_C").Id)==="undefined"){
                                    fields["JobSuite__JS_Client__c"]="";
                                }
                                else{
                                    fields["JobSuite__JS_Client__c"]=component.get("v.selectedLookUpRecord_C").Id;
                                }
                                
                                if(typeof(component.get("v.selectedLookUpRecord_CC").Id)==="undefined"){
                                    fields["JobSuite__JS_Client_Contact__c"]="";
                                }
                                else{
                                    fields["JobSuite__JS_Client_Contact__c"]=component.get("v.selectedLookUpRecord_CC").Id;
                                }
                                ...
                                if(recId!=null ){
                                    ...
                                    if(MarkDoneAll){
                                        fields["JobSuite__marked_Done__c"]=true;
                                    }
                                    else{
                                        fields["JobSuite__marked_Done__c"]=false;
                                    }
                                    if(ApprovePEAll && ShowPE ){
                                        fields["JobSuite__Approve_PE__c"]=true;
                                    }
                                    else{
                                        fields["JobSuite__Approve_PE__c"]=false;
                                    }
                                    
                                }
                                
                                fields["JobSuite__Media_Types__c"]=component.get("v.selectedLookUpRecord_MT").Id;
                                fields["JobSuite__Schedule_Template__c"]=component.get("v.selectedLookUpRecord_ST").Id;
                                var starttimeval;           
                                if(component.find("StartTime")!=null){
                                    ...
                                    if(starttimeval!=null){
                                        if(starttimeval.length==0){
                                            fields["JobSuite__Start_Time__c"]=null; 
                                        }
                                        else{
                                            fields["JobSuite__Start_Time__c"]=starttimeval;
                                        }
                                    }else{
                                        fields["JobSuite__Start_Time__c"]=null;
                                    }
                                ...
                                if(component.find("EndTime")!=null){
                                    ...
                                    if(EndTimeval!=null){
                                        if(EndTimeval.length==0){
                                            fields["JobSuite__End_Time__c"]=null; 
                                        }
                                        else{
                                            fields["JobSuite__End_Time__c"]=EndTimeval;
                                        }
                                    } 
                                    else{
                                        fields["JobSuite__End_Time__c"]=null;
