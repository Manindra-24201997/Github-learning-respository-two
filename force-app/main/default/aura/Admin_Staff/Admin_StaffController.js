({
    doInit : function(component, event, helper) {
        ...
        component.set('v.Staffcolumns', [
            ...
            {label: 'Email', fieldName: 'JobSuite__Email__c', sortable: true, type: 'email'},
            {label: 'Username', fieldName: 'JobSuite__Username__c',sortable: true, type: 'text'},
            {label: 'Role', fieldName: 'JobSuite__Role__c', sortable: true, type: 'text'}
        ]);  
    },
