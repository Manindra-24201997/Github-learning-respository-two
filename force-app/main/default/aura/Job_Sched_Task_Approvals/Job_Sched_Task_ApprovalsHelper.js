({
    ...
    JobTasksfetch : function(component,event) {
        ...
        TaskAction.setCallback(this, function(response){ 
            ...
            if (response.getState() === "SUCCESS") {
                ...
                console.log('>>>>>>>>JobTasksfetch rows>>>>>>>>>>'+JSON.stringify(rows));
        ...
        DeleteSchdule.setCallback(this, function(DelResponse) {
            ...
            if (DelState === "SUCCESS") {
                if(DelResponse.getReturnValue()=="OK"){
                    ...
                    helper.showToast({
                        "type": "success",
                        "message": "Successfully deleted the Approval process."
                    });
        ...
        CreateSchdule.setCallback(this, function(CRSResponse) {
            ...
            if (CRSState === "SUCCESS") {
                if(CRSResponse.getReturnValue()=="OK"){
                    ...
                    helper.showToast({
                        "type": "success",
                        "message": "Successfully created the Approval Process."
                    });
    ...
    TaskEditSucess :function(component,event, helper,TaskId,UpdateRestDays,UpdateRestDates){
        console.log('>>>>>>>>>>>TaskEditSucess helper>>>>>>>>>>>>>>>>>>');
        ...
        TaskSuccessAction.setCallback(this, function(response){ 
            console.log('=====TaskEditSucess State of Task===='+response.getState());
            console.log('=====TaskEditSucess getReturnValue of Task===='+response.getReturnValue());
            if (response.getState() === "SUCCESS") {
                if(response.getReturnValue()=="OK"){
                    ...
                    helper.showToast({
                        "type": "success",
                        "message": "Successfully updated the Approval Step."
                    });
        ...
        undoAct.setCallback(this, function(response){ 
            if (response.getState() === "SUCCESS") {
                if(response.getReturnValue()=="OK"){
                    ...
                    helper.showToast({
                        "type": "success",
                        "message": "The Approval Process has been Recalled."
                    });
        ...
        SubmitAct.setCallback(this, function(response){ 
            if (response.getState() === "SUCCESS") {
                if(response.getReturnValue()=="OK"){
                    ...
                    helper.showToast({
                        "type": "success",
                        "message": "Successfully submitted the approval process."
                    });
        ...
        delTask.setCallback(this, function(response){ 
            if (response.getState() === "SUCCESS") {
                if(response.getReturnValue()=="OK"){
                    ...
                    helper.showToast({
                        "type": "success",
                        "message": "Successfully deleted the Approval step."
                    });
        ...
        SucessAbove.setCallback(this, function(SAboveResponse) {
            ...
            if (SbState === "SUCCESS") {
                if(SAboveResponse.getReturnValue()=="OK"){
                    ...
                    helper.showToast({
                        "type": "success",
                        "message": 'Successfully insert the Approval Step.'
                    });
        ...
        SucessBelow.setCallback(this, function(SbelowResponse) {
            ...
            if (SbelowState === "SUCCESS") {
                if(SbelowResponse.getReturnValue()=="OK"){
                    ...
                    helper.showToast({
                        "type": "success",
                        "message": 'Successfully insert the Approval Step at the End.'
                    });
