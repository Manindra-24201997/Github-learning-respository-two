({
    ...
    handleRowActionReceipt :function(component, event, helper) {
        ...
        component.set('v.MOLIReceiptstatus',row.MPLI_Receipt_Status__c);
        component.set('v.MOLIReceiptQty',row.MOLI_Receipt_Qty__c);
        switch(action.name){
            ...
            case 'Delete_MOLIReceipt':
                helper.deleteMOLIReceipt(component, event, helper,row.Id);
                break;
        }
    },
    ...
    onMPLIReceiptRecordSuccess : function(component,event,helper){
        ...
        component.set('v.MOLIReceiptstatus','');
        ...
        if(Statusvalue == 'Received' && neworedit){
            ...
            helper.showToast({
                "type":"success",
                "message":  "Material Order Line Item Receipt Record Updated Successfully."
            }); 
        }
        ...
        if(Statusvalue == 'Outstanding' && !neworedit){
            ...
            helper.showToast({
                "type":"success",
                "message":  "Material Order Line Item Receipt Record Created Successfully."
            }); 
        }
    },
