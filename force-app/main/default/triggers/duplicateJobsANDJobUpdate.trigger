trigger duplicateJobsANDJobUpdate on Job__c(before insert, before update, after insert, after update, before delete, after delete) {
    ...
    If((Trigger.isBefore && Trigger.isInsert)) {
        ...
        if (jobFlag == False) {
            ...
            //Epson org if condition and first org id in below if condition belongs to chumash sandbox.
            //Below If condition first org id is this org id.
            if(UserInfo.getOrganizationId() == '00D8c000004tXwGEAU' || UserInfo.getOrganizationId()  == '00D7f0000000sfHEAQ' || UserInfo.getOrganizationId() == '00Dm00000002kRBEAY' || UserInfo.getOrganizationId() == '00D7h000000H0GyEAK' || UserInfo.getOrganizationId() == '00Dj0000000HwwREAS' || UserInfo.getOrganizationId() == '00DA0000000Cir8MAC' || UserInfo.getOrganizationId() == '00D3F0000004b48UAA' || UserInfo.getOrganizationId() == '00Dm000000092khEAA')
            {
...
previousJobNumber=previousJobNumber.split(' ')[0];
            ...
            for (Job__c j: Trigger.New) {
                if (j.flag__c == False) {
                    ...
                    //Below If condition first org id is this org id
                    else if ((UserInfo.getOrganizationId() == '00D8c000004tXwGEAU' || UserInfo.getOrganizationId() == '00Dm00000002kRBEAY' || UserInfo.getOrganizationId() == '00D7h000000H0GyEAK' || UserInfo.getOrganizationId() == '00DA0000000Cir8MAC' || UserInfo.getOrganizationId() == '00Dj0000000HwwREAS' || UserInfo.getOrganizationId() == '00D3F0000004b48UAA' || UserInfo.getOrganizationId() == '00Dm000000092khEAA') && j.Revision__c == true) {
                        if(Schema.sObjectType.Job__c.fields.Job_Auto_Number__c.isCreateable()){
                    ...
                    else if ((UserInfo.getOrganizationId() == '00Dm00000002kRBEAY' || UserInfo.getOrganizationId() == '00D7h000000H0GyEAK' || UserInfo.getOrganizationId() == '00Dj0000000HwwREAS' || UserInfo.getOrganizationId() == '00D3F0000004b48UAA' || UserInfo.getOrganizationId() == '00Dm000000092khEAA') && j.Reprint__c == true) {
                        if(Schema.sObjectType.Job__c.fields.Job_Auto_Number__c.isCreateable()){
...
*/
    ...
    if (trigger.isafter && (trigger.isinsert)) {
        ...
        if (jobShares.size() > 0){
            //if(Schema.sObjectType.Job__share.isCreateable()){  insert jobShares;} //This line is commented on 25 - 04 - 2022 because we dont know what is job share.
        }
    }
    ...
    if (trigger.isafter && (trigger.isupdate)) {
        ...
        if (jobShares.size() > 0){
            if(Schema.sObjectType.Job__share.isCreateable()){ 
                // insert jobShares;
            }
        }
    ...
    If((Trigger.isInsert|| Trigger.isUpdate) && Trigger.isAfter) {
        ...
        if(idList.size()>0 && !Test.isRunningTest()){
